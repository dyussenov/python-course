...
Инкапсуляция - один из трех основных принципов ООП, который объединяет данные и методы, работающие с этими данными, в единый объект и скрывает внутреннюю реализацию объекта от внешнего мира.
...
Для разграничения доступа к полям и методам класса в объектно-оринтированных языках программирования существует три уровня доступа. Рассмотрим их по порядку.
